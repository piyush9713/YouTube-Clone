      ...
      <div className="flex items-center justify-between flex-shrink flex-row">
        <div className="flex items-center my-4">
          ...
          <h1 className="font-bold">
            {videoData?.owner?.username || "User Name"}
          </h1>
        ...
        <button
          ...
          {isLiked ? (
            <FaThumbsUp size={24} className="text-base sm:text-xl" />
          ) : (
            <FaRegThumbsUp size={24} className="text-base sm:text-xl hover:" />
          )}
          <span className="text-lg">{likeCount || 0}</span>
        </button>
      </div>
